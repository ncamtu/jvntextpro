...
public class Sentence {
	...
	public static void setPrimaryTagIndex (List<Sentence> data, int primarytagindex) {
		for (Sentence sent: data) {
			for (int i = 0; i < sent.size(); ++i)
				sent.getTWordAt(i).setPrimaryIndex(primarytagindex);
		}
	}
	...
	public void print(Writer out, String separator) throws IOException{
		for (int i = 0; i < sentence.size(); ++i) {
			out.write(sentence.get(i).toString(separator));
			out.write("\n");
		}
		out.write("\n");
	}
