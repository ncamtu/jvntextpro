...
public class ConjunctionContextGenerator extends BasicContextGenerator {
	...
	public static String name = "syll_conj_gen";
	
	public static String cpprefix = "s:";
	...
	public String[] getContext(Sentence sent, int pos) {
		...
		for (int it = 0; it < cpnames.size(); ++it){			
			...
			if (cp.equals(ConjunctionContextGenerator.name)){
				String prefix = ConjunctionContextGenerator.cpprefix;
				String suffix = "";			
